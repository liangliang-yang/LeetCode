#
# @lc app=leetcode id=2408 lang=python
#
# [2408] Design SQL
#
...
# Testcase Example:  '["SQL","insertRow","selectCell","insertRow","deleteRow","selectCell"]\n' +
  '[[["one","two","three"],[2,3,1]],["two",["first","second","third"]],["two",1,3],["two",["fourth","fifth","sixth"]],["two",1],["two",2,2]]'
#
# You are given n tables represented with two arrays names and columns, where
# names[i] is the name of the i^th table and columns[i] is the number of
# columns of the i^th table.
# 
...
# ["two", 1, 3], ["two", ["fourth", "fifth", "sixth"]], ["two", 1], ["two", 2,
# 2]]
# Output
